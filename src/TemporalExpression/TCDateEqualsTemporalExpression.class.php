 ...
 * This file provides a concrete class for determining dates that occur on
 * a given date.
 *
 * @package TitusCrow
...
/**
 * A temporal expression that determines if a date occurs on a
 * given date.
 *
 * @package TitusCrow
 * @subpackage TemporalExpression
 ...
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License
 */
class TCDateEqualsTemporalExpression implements ITCTemporalExpression {
  ...
  /**
   * Evaluates if a date occurs on the reference date.
   *
   * @param TCDate $aDate
