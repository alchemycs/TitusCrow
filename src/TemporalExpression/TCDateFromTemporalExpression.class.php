 ...
 * This file provides a concrete class for determining dates that occur from
 * a given date.
 *
 * @package TitusCrow
...
/**
 * A temporal expression that determines if a date occurs on or after
 ...
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License
 */
class TCDateFromTemporalExpression implements ITCTemporalExpression {
  /**
   *
  ...
  /**
   * Evaluates if a date occurs on or after the reference date.
   *
   * @param TCDate $aDate
   * @return bool TRUE if the date occurs on or after the reference date, FALSE
   * otherwise
   */
