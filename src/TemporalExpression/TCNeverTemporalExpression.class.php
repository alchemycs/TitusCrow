...
/**
 * Provides a temporal expression that returns FALSE for all dates.
 *
 * @package TitusCrow
...
/**
 * A temporal expression that returns FALSE for all dates.
 *
 ...
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License
 */
class TCNeverTemporalExpression implements ITCTemporalExpression {

  /**
   * This expression returns FALSE for all dates.
   *
