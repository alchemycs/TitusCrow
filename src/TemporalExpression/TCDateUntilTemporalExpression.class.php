 ...
 * This file provides a concrete class for determining dates that occur until
 * a given date.
 *
 * @package TitusCrow
...
/**
 * A temporal expression that determines if a date occurs before or on
 * (inclusve) a given date.
 *
 * @package TitusCrow
 * @subpackage TemporalExpression
 * @author  Michael McHugh <alchemist@alchemycs.net.au>
 ...
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License
 */
class TCDateUntilTemporalExpression implements ITCTemporalExpression {
  ...
  /**
   * Evaluates if a date occurs before or on the reference date.
   *
   * @param TCDate $aDate
   * @return bool TRUE if the date occurs after or on the reference date, FALSE
   * otherwise
   */
