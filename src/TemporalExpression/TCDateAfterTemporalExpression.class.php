 ...
 * This file provides a concrete class for determining dates that occur after
 * a given date.
 *
 * @package TitusCrow
...
/**
 * A temporal expression that determines if a date occurs after (exclusive) a
 * given date.
 *
 * @package TitusCrow
 * @subpackage TemporalExpression
 ...
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License
 */
class TCDateAfterTemporalExpression implements ITCTemporalExpression {
  ...
  /**
   * Evaluates if a date occurs after the reference date.
   *
   * @param TCDate $aDate
